...
@section('content')
    ...
    <div class="container-fluid">
        <nav aria-label="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Modifier le profil du client ({{$customer->name}})</li>
            </ol>
        </nav>
                        ...
                        <form action="{{route('customer.update', $customer->id)}}" method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="col-8">
                                    ...
                                    <!-- Text input -->
                                    <div class="form-outline mb-4">
                                        <input type="text" name="phone" value="{{$customer->phone}}" id="phone" class="form-control" />
                                        <label class="form-label" for="phone">Numéro de Téléphone</label>
                                    </div>
                                
                                    <!-- Email input -->
                                    <div class="form-outline mb-4">
                                        <input type="texte" name="num_compte" value="{{$customer->num_compte}}" id="num_compte" class="form-control" />
                                        <label class="form-label" for="num_compte">Numéro Compte Contribuable</label>
                                    </div>
                                
                                    <!-- Number input -->
                                    <div class="form-outline mb-4">
                                        <input type="text" name="intermediaire" value="{{$customer->intermediaire}}" id="intermediaire" class="form-control" />
                                        <label class="form-label" for="intermediaire">Intermédiaire</label>
                                    </div>
                                
                                    <!-- Message input -->
                                    <div class="form-outline mb-4">
                                        <textarea class="form-control" name="activity" id="activity" rows="2">{{$customer->activity}}</textarea>
